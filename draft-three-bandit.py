...
class two_bandit():
    def __init__(self, initial_bias, optimal_arm, trounds):
        ...
        self.dict_list = [self.Heirarchy, self.Interaction_patterns, self.Norms_of_Engagement]
        self.initial_bias = initial_bias
        self.optimal_arm = optimal_arm
        self.total_rounds = trounds

    def reward_generator(self, curr_arms, optimal_arms, noise=0.233):
        """
    ...
    def main(self):
        ...
        for i in range(total_rounds):
            ...
            print(f"Chosen arms: {self.Heirarchy[arms_chosen[0]][1]}, {self.Interaction_patterns[arms_chosen[1]][1]}, {self.Norms_of_Engagement[arms_chosen[2]][1]}\n")
        ...
        return 1 if count == 3 else 0.5 if (count == 2 or count == 1) else 0
