...
from bandits_unconstrained.bandit_framework_dreamteam.algorithms import get_algorithm, ProblemConfig
from bandits_unconstrained.bandit_framework_dreamteam.environment import TeamRewardEnvironment
...
def run_single(algo_cls, config: ProblemConfig, initial_bias: List[int],
               optimal_arm: List[int], total_rounds: int, noise: float) -> List[float]:
